...
while($fila1 = mysqli_fetch_array($sDet, MYSQLI_ASSOC)){
    ...
    $pdf->Cell (45,8,utf8_decode($fila['CodigoProd']),1,0,'L');
    $pdf->Cell (80,8,utf8_decode($fila1['NombreProd']),1,0,'L');
    $pdf->Cell (30,8,utf8_decode('$'.$fila1['Precio']),1,0,'L');
    $pdf->Cell (30,8,utf8_decode('$'.$fila1['Costo']),1,0,'L');
    $pdf->Cell (30,8,utf8_decode($fila1['Stock']),1,0,'L');
    $pdf->Ln(10);
