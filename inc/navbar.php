...
<nav id="navbar-auto-hidden">
        ...
        <div class="row hidden-xs">
            <div class="col-xs-4">
               <img src="./assets/img/logoos.png" width="180" height="57">
            ...
            <div class="col-xs-8">
              <div class="contenedor-tabla pull-right">
                <div class="contenedor-tr">
                  <a href="index.php" class="table-cell-td"><i class="fa fa-home" style="font-size:17px"></i>Inicio</a>
                  <a href="product.php" class="table-cell-td">Productos</a>
                  <?php
                      if(!$_SESSION['nombreAdmin']==""){
                          echo ' 
                              <a href="carrito.php" class="table-cell-td"><i class="fa fa-shopping-cart"></i>  Carrito</a>
                              <a href="configAdmin.php" class="table-cell-td">Administración</a>
                              <a href="#!" class="table-cell-td exit-system">
                                  <i class="fa fa-times"> Cerrar Sesion: </i>&nbsp;&nbsp;'.$_SESSION['nombreAdmin'].'
                              </a>
                           ';
                          ...
                          echo ' 
                              ...
                              <a href="carrito.php" class="table-cell-td"><i class="fa fa-shopping-cart"></i>  Carrito</a>
                              <a href="#!" class="table-cell-td exit-system">
                              <i class="fa fa-times"> Cerrar Sesion: </i>&nbsp;&nbsp;'.$_SESSION['nombreUser'].'
                              </a>
                          ...
                          <a href="registration.php" class="table-cell-td"><i class="fa fa-user-plus"></i>Registrarse</a>
      ...
      <div class="modal-dialog modal-sm">
          <div class="modal-content" id="modal-form-login" style="padding: 15px;">
            ...
            <form action="process/login.php" method="post" role="form" class="FormCatElec" data-form="login">
                ...
                <p>¿Cómo deseas iniciar sesión?</p>
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo">Ossil Envases</h3>
