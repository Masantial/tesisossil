    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>REGISTRO <small class="tittles-pages-logo">Ossil Envases</small></h1>
            </div>
            <p class="lead text-center">
              Por favor registrese con sus datos para poder realizar su pedido.
            </p>
            <div class="row">
                            ...
                            <div class="row">
                              ...
                              <div class="col-xs-12">
                                <div class="form-group label-floating">
                                  <label class="control-label"><i class="fa fa-address-card-o" aria-hidden="true"></i>&nbsp; Ingrese su número de DNI o CUIT</label>
                                  <input class="form-control" type="text" required name="clien-nit" pattern="[0-9]{1,15}" title="Ingrese su número de DNI. Solamente números" maxlength="11" >
                                </div>
                              </div>
                              ...
                              <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                  <label class="control-label"><i class="fa fa-mobile"></i>&nbsp; Ingrese su número de telefono</label>
                                    <input class="form-control" type="tel" required name="clien-phone" maxlength="10" title="Ingrese su número telefónico. Sin 0, Máximo 10">
                                </div>
                              </div>
                              <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                              ...
                              <div class="col-xs-12">
                                <legend><i class="fa fa-lock"></i> &nbsp; Datos de Sesion</legend>
                              </div>
                              <div class="col-xs-12">
                                <div class="form-group label-floating">
