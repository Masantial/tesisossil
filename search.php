       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>BÚSQUEDA DE PRODUCTOS <small class="tittles-pages-logo">Ossil Envases</small></h1>
            </div>
              ...
              <div class="container-fluid">
                <div class="row">
                  ...
                  <?php
                      ...
                      echo '<h2 class="text-center">Lo sentimos, no hemos encontrado productos con el nombre, marca o modelo indicado <strong>"'.$search.'"</strong></h2>';
                    }
                  ?>
                </div>
              </div>
