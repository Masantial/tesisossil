...
$sVenta=ejecutarSQL::consultar("SELECT * FROM venta WHERE NumPedido>1");
...
$pdf->Cell (0,5,('Ossil Envases'),1,1,'C');
$pdf->Ln(20);

//$pdf->SetFont("Times","",14);
//$pdf->Cell (0,5,utf8_decode('Factura de pedido numero '.$pedido),0,1,'C');
$pdf->Cell (50,5,utf8_decode('Fecha del pedido: '),0);
...
$pdf->SetFont("Times","",12);
$suma=0;
$sDet=ejecutarSQL::consultar("SELECT * FROM detalle WHERE NumPedido>1");
