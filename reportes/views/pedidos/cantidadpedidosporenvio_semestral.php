...
<body>
    <header>
        <h2 class="text-center">Sumatoria semestral de pedidos según su tipo de envío</h2>
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <div class="tab-content p-0">
                ...
                let urlPedPen2semestral = 'http://localhost/Tesis-OssilEnvases/reportes/consultas/pedidosporenvio_semestral.php'
                fetch(urlPedPen2semestral)
                    .then(response => response.json())
                    .then(datos => mostrarPedPen2semestral(datos))
                    .catch(error => console.log(error))


                const mostrarPedPen2semestral = (articulos) => {
