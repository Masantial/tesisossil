...
<header>
        <h2 class="text-center">Sumatoria trimestral de pedidos según su estado</h2>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="tab-content p-0">
                ...
                let urlPedPentrimestral = 'http://localhost/Tesis-OssilEnvases/reportes/consultas/pedidosporestado_trimestral.php'
                fetch(urlPedPentrimestral)
                    .then(response => response.json())
                    .then(datos => mostrarPedPentrimestral(datos))
                    .catch(error => console.log(error))


                const mostrarPedPentrimestral = (articulos) => {
