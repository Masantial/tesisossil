...
<header>
        <h2 class="text-center">Sumatoria mensual de pedidos según su estado</h2>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="tab-content p-0">
                ...
                let urlPedPenmensual = 'http://localhost/Tesis-OssilEnvases/reportes/consultas/pedidosporestado_mensual.php'
                fetch(urlPedPenmensual)
                    .then(response => response.json())
                    .then(datos => mostrarPedPenmensual(datos))
                    .catch(error => console.log(error))


                const mostrarPedPenmensual = (articulos) => {
