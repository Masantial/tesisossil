...
<body>
    <header>
        <h2 class="text-center">Sumatoria trimestral de pedidos según su tipo de envío</h2>
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <div class="tab-content p-0">
                ...
                let urlPedPen2trimestral = 'http://localhost/Tesis-OssilEnvases/reportes/consultas/pedidosporenvio_trimestral.php'
                fetch(urlPedPen2trimestral)
                    .then(response => response.json())
                    .then(datos => mostrarPedPen2trimestral(datos))
                    .catch(error => console.log(error))


                const mostrarPedPen2trimestral = (articulos) => {
