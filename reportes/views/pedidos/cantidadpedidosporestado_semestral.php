...
<header>
        <h2 class="text-center">Sumatoria semestral de pedidos según su estado</h2>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="tab-content p-0">
                ...
                let urlPedPensemestral = 'http://localhost/Tesis-OssilEnvases/reportes/consultas/pedidosporestado_semestral.php'
                fetch(urlPedPensemestral)
                    .then(response => response.json())
                    .then(datos => mostrarPedPensemestral(datos))
                    .catch(error => console.log(error))


                const mostrarPedPensemestral = (articulos) => {
