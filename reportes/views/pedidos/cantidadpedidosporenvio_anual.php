...
<body>
    <header>
        <h2 class="text-center">Sumatoria anual de pedidos según su tipo de envío</h2>
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <div class="tab-content p-0">
                ...
                let urlPedPen2anual = 'http://localhost/Tesis-OssilEnvases/reportes/consultas/pedidosporenvio_anual.php'
                fetch(urlPedPen2anual)
                    .then(response => response.json())
                    .then(datos => mostrarPedPen2anual(datos))
                    .catch(error => console.log(error))


                const mostrarPedPen2anual = (articulos) => {
