...
<body>
    <header>
        <h2 class="text-center">Clientes Frecuentes Mensual</h2>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="tab-content p-0">
                ...
                let urlClientesFrecmensual = 'http://localhost/Tesis-OssilEnvases/reportes/consultas/clientesfreccantped_mensual.php'
                fetch(urlClientesFrecmensual)
                    .then(response => response.json())
                    .then(datos => mostrarClientesFrecmensual(datos))
                    .catch(error => console.log(error))


                const mostrarClientesFrecmensual = (articulos) => {
        ...
        <div class="card-body">
            ...
            <div class="tab-content p-0">
                ...
                let urlClientesFrecmonto =
                    'http://localhost/Tesis-OssilEnvases/reportes/consultas/clientesfreccantped_mensual.php'
