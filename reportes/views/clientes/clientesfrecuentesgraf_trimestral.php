...
<body>
    <header>
        <h2 class="text-center">Clientes Frecuentes Trimestral</h2>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="tab-content p-0">
                ...
                let urlClientesFrectrimestral = 'http://localhost/Tesis-OssilEnvases/reportes/consultas/clientesfreccantped_trimestral.php'
                fetch(urlClientesFrectrimestral)
                    .then(response => response.json())
                    .then(datos => mostrarClientesFrectrimestral(datos))
                    .catch(error => console.log(error))


                const mostrarClientesFrectrimestral = (articulos) => {
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="tab-content p-0">
                ...
                let urlClientesFrecmontotrimestral ='http://localhost/Tesis-OssilEnvases/reportes/consultas/clientesfreccantped_trimestral.php'
                fetch(urlClientesFrecmontotrimestral)
                    .then(response => response.json())
                    .then(datos => mostrarClientesFrecmontotrimestral(datos))
                    .catch(error => console.log(error))


                const mostrarClientesFrecmontotrimestral = (articulos) => {
                    articulos.forEach(element => {
