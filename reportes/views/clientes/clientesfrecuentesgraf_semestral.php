...
<body>
    <header>
        <h2 class="text-center">Clientes Frecuentes Semestral</h2>
        <h6 class="text-center">(Se listarán los clientes que tengan al menos 10 pedidos enviados o entregados en el
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="tab-content p-0">
                ...
                let urlClientesFrecsemestral =
                    'http://localhost/Tesis-OssilEnvases/reportes/consultas/clientesfreccantped_semestral.php'
                fetch(urlClientesFrecsemestral)
                    .then(response => response.json())
                    .then(datos => mostrarClientesFrecsemestral(datos))
                    .catch(error => console.log(error))


                const mostrarClientesFrecsemestral = (articulos) => {
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="tab-content p-0">
                ...
                let urlClientesFrecmontosemestral =
                    'http://localhost/Tesis-OssilEnvases/reportes/consultas/clientesfreccantped_semestral.php'
                fetch(urlClientesFrecmontosemestral)
                    .then(response => response.json())
                    .then(datos => mostrarClientesFrecmontosemestral(datos))
                    .catch(error => console.log(error))


                const mostrarClientesFrecmontosemestral = (articulos) => {
                    articulos.forEach(element => {
