...
<body>
<header>
         <h2 class="text-center">Pedidos Diarios</h2>
         <h6 class="text-center">(Se contemplan todos los pedidos del dia de la fecha)</h6>
...
<br>
    ...
    <div class="table-responsive">
        ...
        <table id="pedidosdiarios" class="table table-striped table-bordered" style="width:100%">
            <thead>
                <tr>
...
?>
    ...
    $(document).ready(function() {
        var table = $('#pedidosdiarios').DataTable({
            orderCellsTop: true,
            fixedHeader: true,
            dom: 'Bfrtip',
            buttons: [
        ...
        $('#pedidosdiarios thead tr').clone(true).appendTo('#pedidosdiarios thead');

        $('#pedidosdiarios thead tr:eq(1) th').each(function(i) {
