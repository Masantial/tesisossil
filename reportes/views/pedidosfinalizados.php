...
<body>
<header>
         <h2 class="text-center">Pedidos Finalizados</h2>
         <h6 class="text-center">(Se contemplan los pedidos historicos Finalizados)</h6>
...
JOIN cliente c ON
c.NIT = v.NIT 
where v.Estado in ('Enviado','Entregado')";
