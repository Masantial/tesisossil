...
<body>
<header>
        <h2 class="text-center">Porcentaje Ganancia Neta Trimestral</h2>
...
<div class="card">
    ...
    let urlGananciaNeta_Trimestral = 'http://localhost/Tesis-OssilEnvases/reportes/consultas/GananciaNeta.php'
    fetch(urlGananciaNeta_Trimestral)
        .then(response => response.json())
        .then(datos => mostrarGananciaNeta_Trimestral(datos))
        .catch(error => console.log(error))


    const mostrarGananciaNeta_Trimestral = (articulos) => {
