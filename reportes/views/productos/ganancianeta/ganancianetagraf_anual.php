...
<body>
<header>
        <h2 class="text-center">Porcentaje Ganancia Neta Anual</h2>
...
<div class="card">
    ...
    let urlGananciaNeta_Anual = 'http://localhost/Tesis-OssilEnvases/reportes/consultas/GananciaNeta.php'
    fetch(urlGananciaNeta_Anual)
        .then(response => response.json())
        .then(datos => mostrarGananciaNeta_Anual(datos))
        .catch(error => console.log(error))


    const mostrarGananciaNeta_Anual = (articulos) => {
