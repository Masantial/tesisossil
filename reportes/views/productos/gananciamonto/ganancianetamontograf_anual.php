...
<body>
<header>
        <h2 class="text-center">Monto de Ganancia Neta Anual</h2>
...
<div class="card">
    ...
    let urlGananciaNetaMontoanual = 'http://localhost/Tesis-OssilEnvases/reportes/consultas/ganancianetamonto.php'
    fetch(urlGananciaNetaMontoanual)
        .then(response => response.json())
        .then(datos => mostrarGananciaNetaMontoanual(datos))
        .catch(error => console.log(error))


    const mostrarGananciaNetaMontoanual = (articulos) => {
