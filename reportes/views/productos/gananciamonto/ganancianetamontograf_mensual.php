...
<body>
<header>
        <h2 class="text-center">Monto de Ganancia Neta Mensual</h2>
...
<div class="card">
    ...
    let urlGananciaNetaMontomensual = 'http://localhost/Tesis-OssilEnvases/reportes/consultas/ganancianetamonto.php'
    fetch(urlGananciaNetaMontomensual)
        .then(response => response.json())
        .then(datos => mostrarGananciaNetaMontomensual(datos))
        .catch(error => console.log(error))


    const mostrarGananciaNetaMontomensual = (articulos) => {
