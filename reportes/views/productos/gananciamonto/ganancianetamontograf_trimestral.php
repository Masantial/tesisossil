...
<body>
<header>
        <h2 class="text-center">Monto de Ganancia Neta Trimestral</h2>
...
<div class="card">
    ...
    let urltrimestral = 'http://localhost/Tesis-OssilEnvases/reportes/consultas/ganancianetamonto.php'
    fetch(urltrimestral)
        .then(response => response.json())
        .then(datos => mostrartrimestral(datos))
        .catch(error => console.log(error))


    const mostrartrimestral = (articulos) => {
