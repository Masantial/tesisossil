...
<body>
    <header>
        <h2 class="text-center">Ranking de Productos más Pedidos Semestral</h2>
    ...
    <div class="card">
        ...
        <div class="card" width=10vh; height=10vh>
            ...
            <script>
                ...
                let urlArtMasVendsemestral = 'http://localhost/Tesis-OssilEnvases/reportes/consultas/productosmasvendidos_semestral.php'
                fetch(urlArtMasVendsemestral)
                    .then(response => response.json())
                    .then(datos => mostrarArtMasVendidossemestral(datos))
                    .catch(error => console.log(error))


                const mostrarArtMasVendidossemestral = (articulos) => {
