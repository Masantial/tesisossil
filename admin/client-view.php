...
<ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li>
        <a href="configAdmin.php?view=clientlist"><i class="fa fa-list-ol" aria-hidden="true"></i> &nbsp; Proveedores de la tienda</a>
    </li>
</ul>
<div class="container">
	<div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group label-floating">
                                    ...
                                    <input class="form-control" type="email" name="prove-web">
                                </div>
                            </div>
                        </div>
                    </div>
