...
<ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li>
        <a href="./pdf/listadoproveedores.php?"><i class="fa fa-print" aria-hidden="true"></i> &nbsp; Imprimir</a>          
                  ...
                  <table class="table table-striped table-hover">
                      	...
                      	<tbody>
							...
							<tr>
								...
								<td class="text-center"><?php echo $prov['IDProveedor']; ?></td>
								...
								<td class="text-center">
	                        		<a href="configAdmin.php?view=providerinfo&code=<?php echo $prov['IDProveedor']; ?>" class="btn btn-raised btn-xs btn-success">Actualizar</a>
	                        	</td>
	                        	<td class="text-center">
	                        		<form action="process/delprove.php" method="POST" class="FormCatElec" data-form="delete">
	                        			<input type="hidden" name="nit-prove" value="<?php echo $prov['IDProveedor']; ?>">
