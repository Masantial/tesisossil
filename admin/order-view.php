                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="#!" class="btn btn-raised btn-xs btn-success btn-block btn-up-order"
                                        data-code="<?php echo $order['NumPedido']; ?>">Actualizar Pedido</a>
                                    <?php 
                                ...
                                ?>
                                    <a href="./pdf/pedido.php?id=<?php echo $order['NumPedido'];  ?>"
                                        class="btn btn-raised btn-xs btn-primary btn-block" target="_blank">Imprimir
                                        Pedido</a>
                                    <a>
                                        <form action="process/cancPedido.php" method="POST" class="FormCatElec"
                                            ...
                                            <button type="submit"
                                                class="btn btn-raised btn-xs btn-block btn-danger">Cancelar
                                                Pedido</button>
                                        </form>
                                    </a>
                                </td>
