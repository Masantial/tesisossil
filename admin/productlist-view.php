...
<ul class="breadcrumb" style="margin-bottom: 5px;">
    ...
    <li>
        <a href="configAdmin.php?view=productlist"><i class="fa fa-list-ol" aria-hidden="true"></i> &nbsp; Productos en
            tienda</a>


    </li>
    <li>
        <a href="./pdf/listadoarticulos.php?"><i class="fa fa-print" aria-hidden="true"></i> &nbsp; Imprimir</a>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">$<?php echo $prod['Costo']; ?></td>
                                ...
                                <td class="text-center"><?php echo $prod['StockMin']; ?></td>
                                <td class="text-center">
                                    <?php
                                ...
                                <td class="text-center">
                                    <a href="configAdmin.php?view=productinfo&code=<?php echo $prod['CodigoProd']; ?>"
                                        class="btn btn-raised btn-xs btn-success">Actualizar</a>


                                </td>

                                <td class="text-center">
                                    <form action="process/delprod.php" method="POST" class="FormCatElec"
                                        data-form="delete">
                                        <input type="hidden" name="prod-code"
                                            value="<?php echo $prod['CodigoProd']; ?>">
