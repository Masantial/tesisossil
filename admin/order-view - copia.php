                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <td class="text-center">
                                <a href="#!" class="btn btn-raised btn-xs btn-success btn-block btn-up-order" data-code="<?php echo $order['NumPedido']; ?>">Actualizar Pedido</a>
                                <?php 
                                    if(is_file("./assets/comprobantes/".$order['Adjunto'])){
                                      echo '<a href="./assets/comprobantes/'.$order['Adjunto'].'" target="_blank" class="btn btn-raised btn-xs btn-info btn-block">Comprobante Adjunto</a>';
                                    }
                                ?>
                                <a href="./pdf/pedido.php?id=<?php echo $order['NumPedido'];  ?>" class="btn btn-raised btn-xs btn-primary btn-block" target="_blank">Imprimir Pedido</a>
                            </td>
                            <td class="text-center">
                              <form action="process/delPedido.php" method="POST" class="FormCatElec" data-form="delete">
                                ...
                                <button type="submit" class="btn btn-raised btn-xs btn-danger">Eliminar Pedido</button>  
                              </form>
                            </td>
                            </tr>
                            <?php
