                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                ...
                                <input type="text" class="form-control" value="<?php echo $prod['Costo']; ?>" required maxlength="20" pattern="[0-9.]{1,20}" name="prod-costo">
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                ...
                                <input type="text" class="form-control" value="<?php echo $prod['StockMin']; ?>" required maxlength="10" pattern="[0-9]{1,10}" name="prod-StockMin">
                            </div>
                            </div>
                            <div class="col-xs-12">
