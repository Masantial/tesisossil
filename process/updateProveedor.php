...
if(consultasSQL::UpdateSQL("proveedor", "NombreProveedor='$nameProveUp',Direccion='$dirProveUp',Telefono='$telProveUp',PaginaWeb='$webProveUp'", "IDProveedor='$nitOldProveUp'")){
    echo '<script>
        swal({
