    ...
    <section id="container-pedido">
        <div class="container">
            <div class="page-header">
              <h1>PEDIDOS <small class="tittles-pages-logo">Ossil Envases</small></h1>
            </div>
            <br><br><br>
            <div class="row">
        ...
        <form class="modal-content FormCatElec" action="process/confirmcompra.php" method="POST" role="form" data-form="save">
          ...
          <div class="modal-body">
            ...
            <p>
              ...
              <strong>Numero de CBU:</strong> <?php echo $datBank['NumeroCuenta']; ?><br>
              ...
              <strong>Tipo de cuenta:</strong> <?php echo $datBank['TipoCuenta']; ?><br><br>
                ...
                echo "Ocurrio un error: Parece ser que no se ha configurado la cuenta de banco";
              }
